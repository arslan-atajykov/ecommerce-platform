...
type User struct {
	...
	Password      string                 `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"` // stored as hash
...
var file_proto_user_proto_depIdxs = []int32{
	...
	6, // 8: user.UserService.GetUser:output_type -> user.GetUserResponse
